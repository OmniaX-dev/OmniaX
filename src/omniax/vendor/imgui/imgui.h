...
enum ImGuiTreeNodeFlags_
{
    ...
    //ImGuiTreeNodeFlags_NoScrollOnOpen     = 1 << 14,  // FIXME: TODO_: Disable automatic scroll on TreePop() if node got just open and contents is not visible
...
enum ImGuiHoveredFlags_
{
    ...
    //ImGuiHoveredFlags_AllowWhenBlockedByModal     = 1 << 6,   // Return true even if a modal popup window is normally blocking access to this item/window. FIXME-TODO_: Unavailable yet.
